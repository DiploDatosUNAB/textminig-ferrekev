...
1.  *Ejecuten este código tal cual se presenta.*
...
1.  tokenizar,
2.  hacer un *anti_join* con *variosIdiomas_stop_words*
...
```{r}
# Quitamos algunas palabras que parecen tener problemas de codificación y números que no aportan a la nube

palabras2 <- palabras |> 
  filter(word %in% c("1", "10d0", "10d4", "10d8", "10dc", "10e1", "2", "3", "4", "7528",	"7684", "8cc7"))
...
```{r}
nube <- wordcloud2(palabras , size = 1, minRotation = -pi/6, maxRotation = -pi/6,
